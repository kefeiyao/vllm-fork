#!/bin/bash
# Prefill instance for disaggregated prefill-decode with IPC (NIXL connector)
...
echo "Starting PREFILL instance on port $PORT (devices: $DEVICE_MASK)"
