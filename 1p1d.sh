...
# W8A16
bash ./prefill_ipc.sh -m $model -t 2 -e -b FLASH_ATTN  -d 0,1,2,3 -q fp8 -a "allgather_reducescatter" --dtype bfloat16 -n "0-15:0;16-31:0;64-79:0;80-95:0"
bash ./decode_ipc.sh -m  $model -t 1 --dp 2 -e -b FLASH_ATTN  -d 4,5,6,7 -q fp8 -a "veloci_deepep" --dtype bfloat16 -n "32-47:1;48-63:1;96-111:1;112-127:1"
#bash ./decode_ipc.sh -m  $model -t 1 --dp 2 -e -b FLASH_ATTN  -d 4,5,6,7 -q fp8 -a "allgather_reducescatter" --dtype bfloat16 -n "32-47:1;48-63:1;96-111:1;112-127:1"
